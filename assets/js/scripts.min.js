window.textToHtml = function (e) {
    ...
    var e = Backbone.Model.extend({
        attributes: {html: ""}, fetch: function (e) {
            var i = this;
            this.unset("html", {silent: !0}), $.ajax({
                url: e.url, success: function (e) {
                    var t = $(textToHtml(e));
                    i.set({html: $(".project-detail", t).html()})
                }
            })
        }
        ...
        $gem: null, $gems: null, $headline: null, initialize: function () {
            ...
            this.$gem.css({top: -$(window).height() * i * .2})
        }
        ...
        onProjectCloseClicked: function (e) {
            var i = 0;
            return $(window).scrollTop() > this.$el.offset().top + .6 * $(window).height() && ($("body,html").animate({scrollTop: this.$el.offset().top}, 900, "easeInOutQuart"), i = 1e3), setTimeout(this.closeProject.bind(this), i), this.isLaunched = !1, !1
        },
        ...
        $readMoreTrigger: null, initialize: function () {
        ...
        $headline: null, $content: null, initialize: function () {
        ...
        onMenuItemClicked: function (e) {
            ...
            return this.$trigger.removeClass("is-closeable"), $("html,body").animate({scrollTop: $(i).offset().top - 80}, 1e3, "easeInOutQuart"), this.$el.removeClass("is-visible"), $("body").removeClass("is-offcanvas"), !1
        },
        ...
        onWindowScroll: function (e) {
            var i = this, t = Math.max(0, $(window).scrollTop()), o = this.scrollTop - t;
        ...
        flkty: null, initialize: function () {
            this.$el.flickity({
                cellAlign: "left",
                contain: !0,
                imagesLoaded: !0,
    ...
    Breakpoints = jRespond([{label: "s", enter: 0, exit: 767}, {label: "m", enter: 768, exit: 991}, {
        label: "l",
        enter: 992,
        exit: 1199
    }, {label: "xl", enter: 1200, exit: 1e4}]), App = function () {
        var h, d, u, f = function () {
            ...
            $(".section").each(function () {
                ...
                new r({el: $(this)})
            }), u = new e, mainNavView = new c({el: ".main-nav"}), h = new t({el: ".section-intro"}), letterSectionView = new n({el: ".section-letters"}), heroSectionView = new i({el: $(".section-hero")}), d = new o({el: $(".section-gems")}), workSectionView = new s({
                el: $(".section-work"),
                model: u
